...
De forma a preencher e embelezar o ambiente, foram colocados dragões TODO TODO confirma se são dragóes pls TODO TODO a voar pelo céu. Isto foi possível com a inclusão de B-splines que definem a trajetória do dragão. Assim, enquanto o jogo estiver a decorrer, eles seguirão o trajeto e dão a sensação de vida ao jogo.
...
Explicar as teclas para destruir, criar, alterar blocos, etcs
...
acho que é trocar a textura de um bloco ?.
