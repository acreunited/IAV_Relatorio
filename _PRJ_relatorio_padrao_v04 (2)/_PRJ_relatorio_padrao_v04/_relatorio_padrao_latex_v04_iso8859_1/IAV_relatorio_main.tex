...
Tendo como objetivo manter a \aspas{vida animal} do ambiente, o jogador consegue criar e destruir cubos, premindo os botões dos lados direito e esquerdo do rato, respetivamente. Assim, consegue controlar mais facilmente o posicionamento destes agentes autónomos.

Apesar dos lobos serem independentes, isto é, conseguem \aspas{caçar} a sua presa sem necessidade de intervenção do jogador, as ovelhas não o são, estando dependentes da intervenção humana para se manter vivas. Para as alimentar, o jogador necessita premir a tecla \emph{F} do teclado, fazendo comida aparecer e atraindo ovelhas.
...
Com o intuito de melhorar a experiência do utilizador e não tornar o jogo tão monótono, foi introduzido som, nomeadamente uma música de fundo que toca em \aspas{loop} permanentemente. 

De forma a haver mais interatividade com o jogador, existem sons sonoros em determinadas ações, mais especificamente, acontecem quando: um animal morre; o jogador oferece comida às ovelhas; um animal se alimenta; TODO TODO TODO podemos fazer mais sons, tipo quando jogo termina, salta etc TODO TODO TODO
...
Este projeto final agregou todos os temas lecionados ao longo do semestre, nomeadamente geração procedimental com a construção de um mundo \emph{Minecraft} \cite{Minecraft}, aprendizagem automática onde agentes foram treinados a se alimentarem para sobreviver, e interação Pessoa-Máquina de modo a ser possível ao utilizador interagir e alterar o curso dos acontecimentos.  
